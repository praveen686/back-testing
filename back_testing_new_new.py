    ...
    def set_leg_pairs_by_straddle_times(self, straddle_times: List[str]):
        ...
        for straddle_time in straddle_times:
            ...
            if pe_leg_trade is not None and ce_leg_trade is not None:
                leg_pair = LegPair("", pe_leg_trade[0], ce_leg_trade[0])
...
def run_analysis(status: bool):
    ...
    if status:
        ...
        # lots, weeks_run, buy_legs_cost, margin_needed_for_straddle, average_sl_buy, start_date, end_date = 3, 6, 11, 116000, 480, "2022-02-28", "2022-02-28"
